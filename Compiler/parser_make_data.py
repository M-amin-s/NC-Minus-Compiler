...
case_stmts.set_follow([t_close_crosh, t_default])
...
state_15_1 = State(1015, var_fun_declaration)
state_15 = State(15, var_fun_declaration, is_end=True)
state_11.add_edge(Edge(state_11, state_15, var_declaration_1))
state_11.add_edge(Edge(state_11, state_12, t_open_parant, codegen_method=func_def))
state_12.add_edge(Edge(state_12, state_13, params))
state_13.add_edge(Edge(state_13, state_14, t_close_parant))
state_14.add_edge(Edge(state_14, state_15_1, compound_stmt, codegen_method=save_func_begin))
state_15_1.add_edge(Edge(state_15_1, state_15, t_epsilon, codegen_method=end_func))
...
state_34.add_edge(Edge(state_34, state_35, t_void, codegen_method=ptype_void_dec))
...
state_37.add_edge(Edge(state_37, state_38, t_epsilon, codegen_method=no_params))
...
state_42.add_edge(Edge(state_42, state_43, t_id, codegen_method=pid_param_def))
...
state_48.add_edge(Edge(state_48, state_49, t_int, codegen_method=ptype_int_dec))
state_49.add_edge(Edge(state_49, state_50, t_id, codegen_method=pid_param_def))
...
state_59.add_edge(Edge(state_59, state_60, t_id, codegen_method=pid_param_def))
...
state_62.add_edge(Edge(state_62, state_63, t_open_bracket, codegen_method=array_param_def))
state_63.add_edge(Edge(state_63, state_64, t_close_bracket))
state_62.add_edge(Edge(state_62, state_64, t_epsilon, codegen_method=var_param_def))
...
state_75.add_edge(Edge(state_75, state_76, t_continue, codegen_method=check_for_while))
state_76.add_edge(Edge(state_76, state_77, t_semicolon))
state_75.add_edge(Edge(state_75, state_76, t_break, codegen_method=check_for_while_switch))
state_76.add_edge(Edge(state_76, state_77, t_semicolon))
...
state_91 = State(91, iteration_stmt, is_end=True, codegen_method=[while_jmpu_start, while_label_end, exit_while])
...
state_90.add_edge(Edge(state_90, state_91, statement, codegen_method=[while_jmpc_end, enter_while]))
...
state_96.add_edge(Edge(state_96, state_97, t_semicolon, codegen_method=assign_return))
...
state_103.add_edge(Edge(state_103, state_104, case_stmts, codegen_method=enter_switch))
state_104.add_edge(Edge(state_104, state_105, default_stmt))
state_105.add_edge(Edge(state_105, state_106, t_close_crosh, codegen_method=exit_switch))
...
state_119.add_edge(Edge(state_119, state_120, t_id, codegen_method=pid_ref))
...
state_137_1 = State(1137, expression_ob_1)
state_138 = State(138, expression_ob_1, is_end=True)
state_136.add_edge(Edge(state_136, state_137, t_equal))
state_137.add_edge(Edge(state_137, state_137_1, expression))
state_137_1.add_edge(Edge(state_137_1, state_138, t_epsilon, codegen_method=assignment))
...
state_151.add_edge(Edge(state_151, state_152, t_open_parant, codegen_method=push_num_of_args))
state_152.add_edge(Edge(state_152, state_153, args))
state_153.add_edge(Edge(state_153, state_154, t_close_parant))
state_154.add_edge(Edge(state_154, state_155, term_1, codegen_method=call_function))
...
state_158.add_edge(Edge(state_158, state_159, t_close_bracket, codegen_method=arr_ref))
state_156.add_edge(Edge(state_156, state_159, t_epsilon, codegen_method=var_ref))
...
state_164_1 = State(1164, simple_expression_1)
state_165 = State(165, simple_expression_1, is_end=True)
state_163.add_edge(Edge(state_163, state_164, relop))
state_164.add_edge(Edge(state_164, state_164_1, additive_expression))
state_164_1.add_edge(Edge(state_164_1, state_165, t_epsilon, codegen_method=relopc))
...
state_166.add_edge(Edge(state_166, state_168, t_double_equal, codegen_method=relop_eq))
state_166.add_edge(Edge(state_166, state_168, t_lower, codegen_method=relop_lt))
...
state_174_1 = State(1174, additive_expression_1)
state_174 = State(174, additive_expression_1, is_end=True)
state_172.add_edge(Edge(state_172, state_173, addop))
state_173.add_edge(Edge(state_173, state_174_1, additive_expression))
state_174_1.add_edge(Edge(state_174_1, state_174, t_epsilon, codegen_method=addopc))
...
state_175.add_edge(Edge(state_175, state_176, t_plus, codegen_method=addop_p))
state_175.add_edge(Edge(state_175, state_176, t_minus, codegen_method=addop_m))
...
state_181_1 = State(1181, term_1)
state_182 = State(182, term_1, is_end=True)
state_180.add_edge(Edge(state_180, state_181, t_star))
state_181.add_edge(Edge(state_181, state_181_1, term))
state_181_1.add_edge(Edge(state_181_1, state_182, t_epsilon, codegen_method=multopc))
...
state_184_1 = State(1184, signed_factor)
...
state_184.add_edge(Edge(state_184, state_184_1, factor))
state_184_1.add_edge(Edge(state_184_1, state_185, t_epsilon, codegen_method=negate_factor))
...
state_186.add_edge(Edge(state_186, state_189, t_id, codegen_method=func_call_name))
state_189.add_edge(Edge(state_189, state_190, var_call))
state_186.add_edge(Edge(state_186, state_190, t_num, codegen_method=push_num_exp))
...
state_191.add_edge(Edge(state_191, state_192, t_open_parant, codegen_method=push_num_of_args))
state_192.add_edge(Edge(state_192, state_193, args))
state_193.add_edge(Edge(state_193, state_194, t_close_parant, codegen_method=call_function))
...
state_203.add_edge(Edge(state_203, state_204, arg_list_1, codegen_method=swap_name))
...
state_218_1 = State(1218, signed_factor_id_2)
...
state_218.add_edge(Edge(state_218, state_218_1, factor))
state_218_1.add_edge(Edge(state_218_1, state_219, t_epsilon, codegen_method=negate_factor))
...
state_220.add_edge(Edge(state_220, state_223, t_num, codegen_method=push_num_exp))
