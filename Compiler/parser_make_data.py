...
expression_ob_1.set_first([t_equal, t_star, t_epsilon, t_plus, t_minus, t_lower])
term_id_ob_2.set_first([t_open_parant])
var_1.set_first([t_open_bracket, t_epsilon])
simple_expression_1.set_first([t_epsilon, t_lower, t_equal])
relop.set_first([t_lower, t_equal])
...
expression_id_1.set_first([t_open_bracket, t_epsilon, t_equal, t_star, t_plus, t_minus, t_lower, t_open_parant])
additive_expression_id_ob_1.set_first([t_star, t_epsilon, t_plus, t_minus])
...
simple_expression_id_ob_1.set_first([t_star, t_epsilon, t_plus, t_minus, t_lower, t_equal])
...
simple_expression_id_1.set_first([t_open_parant, t_open_bracket, t_epsilon, t_star, t_plus, t_minus, t_lower, t_equal])
...
additive_expression_id_1.set_follow([t_lower, t_equal])
term_id_1.set_follow([t_plus, t_minus, t_lower, t_equal])
signed_factor_id.set_follow([t_star, t_plus, t_minus, t_lower, t_equal])
...
additive_expression_id_ob_1.set_follow([t_lower, t_equal, t_close_parant, t_comma, t_close_bracket, t_semicolon])
simple_expression_id_ob_2.set_follow([t_close_parant, t_comma, t_close_bracket, t_semicolon])
additive_expression_id_ob_2.set_follow([t_lower, t_equal, t_close_parant, t_comma, t_close_bracket, t_semicolon])
term_id_ob_2.set_follow([t_plus, t_minus, t_lower, t_equal, t_close_parant, t_comma, t_close_bracket, t_semicolon])
var_1.set_follow([t_equal, t_star, t_plus, t_minus, t_lower, t_close_parant, t_comma, t_close_bracket, t_semicolon])
...
additive_expression.set_follow([t_lower, t_equal, t_close_parant, t_comma, t_close_bracket, t_semicolon])
additive_expression_1.set_follow([t_lower, t_equal, t_close_parant, t_comma, t_close_bracket, t_semicolon])
addop.set_follow([t_plus, t_minus, t_open_parant, t_id, t_num])
term.set_follow([t_plus, t_minus, t_lower, t_equal, t_close_parant, t_comma, t_close_bracket, t_semicolon])
term_1.set_follow([t_plus, t_minus, t_lower, t_equal, t_close_parant, t_comma, t_close_bracket, t_semicolon])
signed_factor.set_follow([t_star, t_plus, t_minus, t_lower, t_equal, t_close_parant, t_comma, t_close_bracket, t_semicolon])
factor.set_follow([t_star, t_plus, t_minus, t_lower, t_equal, t_close_parant, t_comma, t_close_bracket, t_semicolon])
var_call.set_follow([t_star, t_plus, t_minus, t_lower, t_equal, t_close_parant, t_comma, t_close_bracket, t_semicolon])
call.set_follow([])
...
additive_expression_id_2.set_follow([t_lower, t_equal, t_close_parant, t_comma, t_close_bracket, t_semicolon])
term_id_2.set_follow([t_plus, t_minus, t_lower, t_equal, t_close_parant, t_comma, t_close_bracket, t_semicolon])
signed_factor_id_2.set_follow([t_star, t_plus, t_minus, t_lower, t_equal, t_close_parant, t_comma, t_close_bracket, t_semicolon])
factor_id_1.set_follow([t_star, t_plus, t_minus, t_lower, t_equal, t_close_parant, t_comma, t_close_bracket, t_semicolon])
...
state_8.add_edge(Edge(state_8, state_9, t_id))
...
state_20.add_edge(Edge(state_20, state_24, t_semicolon))
state_20.add_edge(Edge(state_20, state_21, t_open_bracket))
state_21.add_edge(Edge(state_21, state_22, t_num))
state_22.add_edge(Edge(state_22, state_23, t_close_bracket))
state_23.add_edge(Edge(state_23, state_24, t_semicolon))
...
state_25.add_edge(Edge(state_25, state_26, t_int))
state_25.add_edge(Edge(state_25, state_26, t_void))
...
state_69 = State(69, compound_stmt, is_end=True)
state_65.add_edge(Edge(state_65, state_66, t_open_crosh))
state_66.add_edge(Edge(state_66, state_67, declaration_list))
...
state_82.add_edge(Edge(state_82, state_83, statement))
state_83.add_edge(Edge(state_83, state_84, t_else))
state_84.add_edge(Edge(state_84, state_85, statement))
...
state_91 = State(91, iteration_stmt, is_end=True)
state_86.add_edge(Edge(state_86, state_87, t_while))
state_87.add_edge(Edge(state_87, state_88, t_open_parant))
...
state_106 = State(106, switch_stmt, is_end=True)
state_98.add_edge(Edge(state_98, state_99, t_switch))
...
state_103.add_edge(Edge(state_103, state_104, case_stmt))
...
state_114 = State(114, case_stmt, is_end=True)
state_110.add_edge(Edge(state_110, state_111, t_case))
state_111.add_edge(Edge(state_111, state_112, t_num))
state_112.add_edge(Edge(state_112, state_113, t_semicolon))
...
state_166.add_edge(Edge(state_166, state_167, t_equal))
state_167.add_edge(Edge(state_167, state_168, t_equal))
...
state_186.add_edge(Edge(state_186, state_189, id))
